...
if __name__ == '__main__':
    ...
    # Import data
    # dm.read_multiple_data_files([49, 50, 51, 52, 53, 54, 55, 56])  # Uncomment for running summer analysis
    dm.read_multiple_data_files([55, 56, 57, 58, 59, 60, 61])  # Uncomment for running autumn analysis
